% -----------------------------------------------------------------
% Tutorials for Computational Neuroscience: Vision
% A bi-annual course held at Cold Spring Harbor Laboratories.
% Eero Simoncelli, E.J. Chichilnisky, Paul Glimcher
% -----------------------------------------------------------------
%
% The "tutorials" are matlab M-files that are not meant to be executed
% from the command line.  They are instead meant to be used as
% scripts.  Load a file into your editor, and read through the comment
% text, cutting and pasting the matlab commands into the matlab
% interpeter window. 
%
% colorSpaceTutorial - basic color calculations, color spaces
% colorRenderingTutorial - using color calculations to render color images
% bayesTutorial - Bayesian estimation
% sdtTutorial - signal detection theory
% choiceProbabilityTutorial - 
% linSysTutorial - linear systems theory, in one dimension
% diffeqTutorial - numerical solutions of differential equations
% samplingTutorial - the sampling theorem
% imageTutorial - 2D filtering, image processing
% imageFormationTutorial - optics of imaging in the human eye
% pyramidTutorial - multi-scale pyramid representations of signals/images
% motionTutorial  - visual motion analysis
% V1MTTutorial   - V1/MT neural model  for motion processing
% intAndFireTutorial - simple model of spiking in neurons
% poissonTutorial - simulations of Poisson spiking behavior in neurons
% gamSpikeTrainTutorial - simulations of more-than-Poisson spiking
% whiteNoiseTutorial - white noise estimation of response properties of neurons
% maskingTutorial - simulation of psychophysical masking experiment
%% -----------------------------------------------------------------
% Tutorials for Computational Neuroscience: Vision
% A bi-annual course held at Cold Spring Harbor Laboratories.
% Eero Simoncelli, E.J. Chichilnisky, Paul Glimcher
