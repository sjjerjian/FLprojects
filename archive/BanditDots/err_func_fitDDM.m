...
% % %             legend('RIGHT','LEFT');
            ...
            dur_rightHigh = data.dur(I & data.dotchoice==1 & data.conf>=0.5);
            dur_rightLow = data.dur(I & data.dotchoice==1 & data.conf<0.5);
            dur_leftHigh = data.dur(I & data.dotchoice==0 & data.conf>=0.5);
            dur_leftLow = data.dur(I & data.dotchoice==0 & data.conf<0.5);
            minP = 1e-300;
