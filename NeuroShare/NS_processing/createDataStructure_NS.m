...
% save header info
nsdata.hdr.pldaps_filename = pldaps_filename; 
nsdata.hdr.Ripple_filename = filename;
nsdata.hdr.Ripple_filepath = completeFilePath;
nsdata.hdr.dataType = dataType; 
nsdata.hdr.dataChannel = dataChannel; 
nsdata.hdr.infolabels = infolabels; 
