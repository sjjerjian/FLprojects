...
%     EXAMPLE
%     
%     data = choiceMat2Struct([sCoh choice rt]) ;
%     startValues = [10 1 .5 .5 .35 .05 0 0] ;
%     boundShape = 'Logistic' ;
%     [params, NLL, f] = FitDTB_CB(data, startValues, boundShape) ;
%     
%     
% 
...
% options =   optimoptions(@fmincon, 'Display',   'iter',   'Maxiter',   1000,   'MaxFuneval',   2000,   'Algorithm',   'interior-point', 'UseParallel', false ) ;
