...
% v         = params(6) ; % 0 by default. Variance parameter (0 if no scaling)
% 
...
%     
%     [params, NLL, f] = FitAccumulationModel(d,startValues,useChoiceFlag, biasCorrFlag, 'k', 10) ;
%     
...
objFun  = @(params) GetAccumulationNLL(params, d, 0, useChoiceFlag, 0, 1,...
...
[NLL, f] = GetAccumulationNLL(params, d, 0, 3, 1, 1,...
    'k',k, 'B', B, 'tND_right',tND_right,'tNDmax_right',tNDmax_right,...
    'tND_left',tND_left,'tNDmax_left',tNDmax_left, 'tNDmax', tNDmax)  ;
